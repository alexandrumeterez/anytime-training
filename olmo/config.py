...
class ModelConfig(BaseConfig):
    ...
    ema_decay: List[float] = field(default_factory=list)
    """
    The decay rate for the exponential moving average (EMA) of model parameters.
    """

    use_ema: bool = False
    """
    Whether to use EMA of model parameters during evaluation.
    """
...
class SchedulerType(StrEnum):
    ...
    sqrt_with_warmup = "sqrt_with_warmup"
...
class TrainConfig(BaseConfig):
    ...
    custom_checkpoint_saving_list: List[int] = field(default_factory=list)
    """
    Custom save checkpoint list.
    """
