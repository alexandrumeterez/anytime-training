...
#SBATCH --output=/n/netscratch/sham_lab/Lab/pranavajitnair/continual_learning_logs/%A_%a.log
#SBATCH --nodes=1              
...
#SBATCH --mem=375GB
#SBATCH --partition=kempner_h100_priority,kempner_h100
#SBATCH --array=21-29
...
export SWEEP_CONFIG=configs/kempner/sweeps/wsd_decays/wsd_decay.yaml
export CHECKPOINTS_PATH=/n/netscratch/sham_lab/Lab/pranavajitnair/continual_learning
